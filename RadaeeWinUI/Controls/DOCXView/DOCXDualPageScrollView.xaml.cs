...
{
    public sealed partial class DOCXDualPageScrollView : DOCXView
    {
        ...
        private void InitializeLayout()
        {
            ...
            _layoutManager.CurrentViewMode = ViewMode.DualPageContinuous;
            ...
            for (int i = 0; i < mDocument.PageCount; i++)
            {
                ...
                float scale = (float)(containerWidth / (pageWidth * 2));
        ...
        private float GetCurrentScale()
        {
            ...
            float pageWidth = vPageGetWidth(0);
        ...
        public override void vPageGoto(int pageIndex)
        {
            ...
            float scale = (float)(containerWidth / (pageWidth * 2));
            double scaledPageHeight = pageHeight * ZoomLevel * scale;

            double targetScrollY = pagePos.y + (scaledPageHeight / 2) - (MainScrollViewer.ViewportHeight / 2);
            targetScrollY = Math.Max(0, targetScrollY);

            MainScrollViewer.ChangeView(null, targetScrollY, null, false);
        ...
        private void CreatePageContainer(PageLayoutInfo pageInfo)
        {
            ...
            container.SetSize(pageInfo.Width, pageInfo.Height);
            container.SetPosition(pageInfo.X, pageInfo.Y);
