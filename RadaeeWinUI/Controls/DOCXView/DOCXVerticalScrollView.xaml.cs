...
{
    public sealed partial class DOCXVerticalScrollView : DOCXView
    {
        ...
        private async Task RenderPageAsync(int pageIndex)
        {
            ...
            try
            {
                ...
                else if (bitmap != null && !cts.Token.IsCancellationRequested && _pageContainers.TryGetValue(pageIndex, out var pageContainer))
                {
